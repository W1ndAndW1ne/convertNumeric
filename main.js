// const convertNumeric = require('./convertNumeric.js');
...
function convertDisplay() {
    ...
    var sourceBase = document.getElementById('sourceBase').value;
    var destBase = document.getElementById('destBase').value;
    document.getElementById('destText').innerHTML = convertNumeric(source, sourceBase, destBase);
}